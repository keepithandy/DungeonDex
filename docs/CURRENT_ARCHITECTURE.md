...
The Elite Contract surface established in v1.27 offers three named hunts, permits one active contract, marks only the exact matching target in combat, pays through the existing one-time Town claim, and projects existing history into read-only Guild Journal cards.
