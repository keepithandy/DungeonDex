...
- Release candidate and local package version: v1.33.3 Oathkeeper's Polish
- Visible semantic version: `1.33.3`
- Build/cache slug: `1.33.3-oathkeepers-polish`
...
The authorized v1.33.3 Oathkeeper's Polish pass aligns release records and runtime labels. Any resulting ZIP remains an output, not version authority.
