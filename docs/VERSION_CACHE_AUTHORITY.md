...
- Release candidate and local package version: v1.31.0 Town, Gear & Guild Navigation Quality of Life
- Visible semantic version: `1.31.0`
- Build/cache slug: `1.31.0-town-gear-navigation-qol`
...
The authorized v1.31.0 release-candidate pass aligns release records and runtime labels. Any resulting ZIP remains an output, not version authority.
