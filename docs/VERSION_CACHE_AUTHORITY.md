...
- Release candidate and local package version: v1.32.2 Merchant Upgrade Hotfix
- Visible semantic version: `1.32.2`
- Build/cache slug: `1.32.2-merchant-upgrade-hotfix`
...
The authorized v1.32.2 hotfix pass aligns release records and runtime labels. Any resulting ZIP remains an output, not version authority.
