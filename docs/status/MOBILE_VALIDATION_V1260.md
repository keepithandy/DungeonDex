...
| Gear filters, actions, inspection, and named loadouts | `#slotFilter`, `#rarityFilter`, `#sortFilter`, `#searchFilter`, `#sellJunkGearBtn`, `#sellAllGearBtn`, `[data-equip]`, `[data-sell]`, `[data-retire]`, `[data-clear-gear-filters]`, `[data-gear-flag]`, `[data-gear-detail-trigger]`, `#namedLoadoutName`, `[data-named-loadout-action]` | 44px | Item protection/junk controls, bulk previews, filter reset, pointer and keyboard inspection, and loadout actions remain reachable and wrap cleanly. | Form controls, bulk actions, mini actions, role-buttons, and named-loadout actions are included by the final touch rule. |
