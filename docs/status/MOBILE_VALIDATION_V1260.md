...
| Gear filters, actions, inspection, and named loadouts | `#slotFilter`, `#rarityFilter`, `#sortFilter`, `#searchFilter`, `#sellJunkGearBtn`, `#sellAllGearBtn`, `#retireArchiveBtn`, `[data-equip]`, `[data-sell]`, `[data-retire]`, `[data-gear-detail-trigger]`, `#namedLoadoutName`, `[data-named-loadout-action]` | 44px | Item and loadout actions wrap; pointer and keyboard inspection share the same read-only detail action; loadout reorder controls retain visible labels. | Form controls, bulk actions, mini actions, role-buttons, and named-loadout actions are included by the final touch rule. |
