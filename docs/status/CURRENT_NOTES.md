...
- The next release gate is fresh physical-device/Textastic testing with `REAL_DEVICE_HANDOFF_V128.md`; earlier device exceptions do not carry forward. Local commits and merge are authorized; no version/cache change, retained release artifact, tag, push or upload is included.
