...
Current baseline: **v1.28.1 Drowned Reliquary: First Descent**.
...
| Merchant Gear Upgrades | The active simple progression path for eligible equipped weapons, armor, and Offhands. |
...
| Retired gear record | Journal history for a retired item; it does not make Famous Gear Memory active in v1.28.1. |
| Trophy Echo | The only active Revisit lane in v1.28.1. It reflects on an earned boss record without adding rewards or replacing a dungeon run. |
...
| Famous Gear Memory / Rival Trace / Board Echo / Debt Pressure Revisit | Inactive Revisit concepts in the v1.28.1 baseline. |
...
| Famous Gear Memory | Inactive in v1.28.1; no active-surface copy target. |
| Rival Trace | Inactive in v1.28.1; no active-surface copy target. |
| Board Echo | Inactive in v1.28.1; no active-surface copy target. |
| Debt Pressure | Inactive in v1.28.1; no active-surface copy target. |
...
- Trophy Echo is the only active Revisit lane in v1.28.1.
