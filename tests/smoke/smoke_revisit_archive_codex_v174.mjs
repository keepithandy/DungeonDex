...
async function main() {
  ...
  record(
    'Archive Codex Revisit smoke retired for v1.31.1',
    surface.includes('v1.31.1 Revisit surface: Trophy Echo only'),
    'active Revisit surface is Trophy Echo-only'
  );

  record(
    'No Archive Codex requirement blocks compact smoke',
    !readme.includes('Revisit Archive Codex is required for v1.31.1')
      && !notes.includes('Revisit Archive Codex is required for v1.31.1'),
