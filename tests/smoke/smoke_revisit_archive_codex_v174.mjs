...
async function main() {
  ...
  record(
    'Archive Codex Revisit smoke retired for v1.26.4.04',
  ...
  record(
    ...
    !readme.includes('Revisit Archive Codex is required for v1.26.4.04')
      && !notes.includes('Revisit Archive Codex is required for v1.26.4.04'),
