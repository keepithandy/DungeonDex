...
async function main() {
  ...
  record(
    'Archive Codex Revisit smoke retired for v1.29.0',
    surface.includes('v1.29.0 Revisit surface: Trophy Echo only'),
    'active Revisit surface is Trophy Echo-only'
  );

  record(
    'No Archive Codex requirement blocks compact smoke',
    !readme.includes('Revisit Archive Codex is required for v1.29.0')
      && !notes.includes('Revisit Archive Codex is required for v1.29.0'),
