...
async function main() {
  ...
  record('Public shell names the current game and Journal', index.includes('<title>DungeonDex v1.31.1</title>') && index.includes('aria-label="Guild Journal"'), 'title and Guild Journal surface');
  ...
  console.log(`\nPublic-copy v1.31.1 smoke: ${passed}/${results.length} passed`);
