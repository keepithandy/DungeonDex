...
async function main() {
  ...
  record('Public shell names the current game and Journal', index.includes('<title>DungeonDex v1.32.0</title>') && index.includes('aria-label="Guild Journal"'), 'title and Guild Journal surface');
  ...
  console.log(`\nPublic-copy v1.32.0 smoke: ${passed}/${results.length} passed`);
