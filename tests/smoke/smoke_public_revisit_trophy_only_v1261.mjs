...
assert.match(lockdownSource, /1\.27-the-contract-board/, 'lockdown report should use the v1.27 public build key');
assert.match(lockdownSource, /const VISIBLE_BUILD = '1\.27';/, 'lockdown report should expose the v1.27 visible build');
...
console.log('PASS: v1.27 public Revisit is Trophy Echo-only across DOM markup, route previews, global mutation functions, and exported API methods.');
