...
assert.match(lockdownSource, /1\.26\.3\.02-town-runtime-layer-cleanup/, 'lockdown report should use the v1.26.3.02 public build key');
assert.match(lockdownSource, /const VISIBLE_BUILD = '1\.26\.3\.02';/, 'lockdown report should expose the v1.26.3.02 visible build');
...
console.log('PASS: v1.26.3.02 public Revisit is Trophy Echo-only across DOM markup, route previews, global mutation functions, and exported API methods.');