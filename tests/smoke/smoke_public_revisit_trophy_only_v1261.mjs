...
assert.match(lockdownSource, /1\.26\.6-ashen-anvil-reinforcements/, 'lockdown report should use the v1.26.6 public build key');
assert.match(lockdownSource, /const VISIBLE_BUILD = '1\.26\.6';/, 'lockdown report should expose the v1.26.6 visible build');
...
console.log('PASS: v1.26.6 public Revisit is Trophy Echo-only across DOM markup, route previews, global mutation functions, and exported API methods.');
