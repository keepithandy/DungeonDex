...
assert.match(lockdownSource, /1\.32\.2-merchant-upgrade-hotfix/, 'lockdown report should use the v1.32.2 public build key');
assert.match(lockdownSource, /const VISIBLE_BUILD = '1\.32\.2';/, 'lockdown report should expose the v1.32.2 visible build');
...
console.log('PASS: v1.32.2 public Revisit is Trophy Echo-only across DOM markup, route previews, global mutation functions, and exported API methods.');
