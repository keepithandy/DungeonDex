...
assert.match(lockdownSource, /1\.33\.3-oathkeepers-polish/, 'lockdown report should use the v1.33.3 public build key');
assert.match(lockdownSource, /const VISIBLE_BUILD = '1\.33\.3';/, 'lockdown report should expose the v1.33.3 visible build');
...
console.log('PASS: v1.33.3 public Revisit is Trophy Echo-only across DOM markup, route previews, global mutation functions, and exported API methods.');
