...
async function main() {
  ...
  record(
    'Revisit surface is v1.29.0 Trophy Echo only',
    has(surface, 'v1.29.0 Revisit surface: Trophy Echo only')
      && has(surface, 'Trophy Echo is the only active Revisit lane for v1.29.0.'),
  ...
  record(
    ...
    has(version, 'v1.29.0 Drowned Reliquary')
