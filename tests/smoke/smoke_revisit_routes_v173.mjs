...
async function main() {
  ...
  record(
    'Revisit surface is v1.26.4.06 Trophy Echo only',
    has(surface, 'v1.26.4.06 Revisit surface: Trophy Echo only')
      && has(surface, 'Trophy Echo is the only active Revisit lane for v1.26.4.06.'),
  ...
  record(
    ...
    has(version, 'v1.26.4.06 Mobile Interface Audit Closure')
