...
async function main() {
  ...
  record(
    'Revisit surface is v1.32.2 Trophy Echo only',
    has(surface, 'v1.32.2 Revisit surface: Trophy Echo only')
      && has(surface, 'Trophy Echo is the only active Revisit lane for v1.32.2.'),
  ...
  record(
    ...
    has(version, 'v1.32.2 Merchant Upgrade Hotfix')
