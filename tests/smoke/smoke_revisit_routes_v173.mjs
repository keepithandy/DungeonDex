...
async function main() {
  ...
  record(
    'Revisit surface is v1.31.0 Trophy Echo only',
    has(surface, 'v1.31.0 Revisit surface: Trophy Echo only')
      && has(surface, 'Trophy Echo is the only active Revisit lane for v1.31.0.'),
  ...
  record(
    ...
    has(version, 'v1.31.0 Town, Gear & Guild Navigation Quality of Life')
