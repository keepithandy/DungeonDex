...
const VISIBLE_BUILD = '1.33.3';
const RELEASE_NAME = "Oathkeeper's Polish";
const RELEASE_LABEL = `v${VISIBLE_BUILD} ${RELEASE_NAME}`;
const BUILD_QS = '1.33.3-oathkeepers-polish';
const PUBLIC_DEPLOYMENT_STATUS = 'The observed hosted runtime is labeled v1.28.2 and its latest downloadable package is DungeonDex_v1.27_ItchReady (2).zip. The v1.33.3 candidate is local only until an explicitly authorized upload.';
