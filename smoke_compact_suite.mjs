...
const COMMANDS = [
  ...
  { tag: 'public', name: 'public copy v1.28.0', cmd: ['node', 'tests/smoke/smoke_public_copy_v1260.mjs'], optionalPath: 'tests/smoke/smoke_public_copy_v1260.mjs' },
  { tag: 'public', name: 'public trophy-only revisit v1.28.0', cmd: ['node', 'tests/smoke/smoke_public_revisit_trophy_only_v1261.mjs'], optionalPath: 'tests/smoke/smoke_public_revisit_trophy_only_v1261.mjs' },
  { tag: 'app', name: 'devtools gate v1.28.0', cmd: ['node', 'tests/smoke/smoke_devtools_gate_v1262.mjs'], optionalPath: 'tests/smoke/smoke_devtools_gate_v1262.mjs' },
  { tag: 'town', name: 'town runtime cleanup v1.28.0', cmd: ['node', 'tests/smoke/smoke_town_runtime_cleanup_v126302.mjs'] },
  ...
  { tag: 'app', name: 'mobile layout contracts v1.28.0', cmd: ['node', 'tests/smoke/smoke_mobile_layout_contracts_v1264.mjs'] },
  { tag: 'app', name: 'touch navigation geometry', cmd: ['node', 'tools/capture_town_mobile_screenshots.mjs', '--verify-geometry'] },
  { tag: 'app', name: 'interface accessibility v1.28.0', cmd: ['node', 'tests/smoke/smoke_interface_accessibility_v1264.mjs'] },
