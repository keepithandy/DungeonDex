...
const COMMANDS = [
  ...
  { tag: 'syntax', name: 'trophy echo result detail smoke syntax', cmd: ['node', '--check', 'smoke_trophy_echo_result_detail_v11.mjs'], optionalPath: 'smoke_trophy_echo_result_detail_v11.mjs' },
  { tag: 'syntax', name: 'public copy smoke syntax', cmd: ['node', '--check', 'smoke_public_copy_v1260.mjs'], optionalPath: 'smoke_public_copy_v1260.mjs' },
  ...
  { tag: 'syntax', name: 'merchant upgrade smoke syntax', cmd: ['node', '--check', 'smoke_merchant_gear_upgrades_v1238.mjs'] },
  ...
  { tag: 'revisit', name: 'trophy echo result detail', cmd: ['node', 'smoke_trophy_echo_result_detail_v11.mjs'], optionalPath: 'smoke_trophy_echo_result_detail_v11.mjs' },
  { tag: 'public', name: 'public copy v1.26', cmd: ['node', 'smoke_public_copy_v1260.mjs'], optionalPath: 'smoke_public_copy_v1260.mjs' },
  ...
  { tag: 'merchant', name: 'merchant gear upgrades', cmd: ['node', 'smoke_merchant_gear_upgrades_v1238.mjs'] }
];
