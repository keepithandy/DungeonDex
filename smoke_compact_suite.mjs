...
const COMMANDS = [
  ...
  { tag: 'syntax', name: 'rarity progression audit smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_rarity_progression_audit_v1280.mjs'] },
  { tag: 'syntax', name: 'Reliquary slice smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_drowned_reliquary_vertical_slice_v1281.mjs'] },
  { tag: 'syntax', name: 'Reliquary content slice smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_drowned_reliquary_content_slice_v1.mjs'] },
  { tag: 'syntax', name: 'Reliquary events smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_drowned_reliquary_events_v1290.mjs'] },
  ...
  { tag: 'syntax', name: 'debt and Talent compatibility smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_debt_talent_compatibility_v1265.mjs'] },
  { tag: 'syntax', name: 'app wiring smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_app_wiring_cache_manifest_v1.mjs'] },
  { tag: 'syntax', name: 'spell mastery smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_spell_mastery_v132.mjs'] },
  { tag: 'syntax', name: 'Guild Oaths smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_guild_oaths_v133.mjs'] },
  { tag: 'syntax', name: 'Lantern Rites smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_lantern_rites_v133.mjs'] },
  { tag: 'syntax', name: 'Crimson Oath QoL smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_guildbound_qol_v133.mjs'] },
  ...
  { tag: 'syntax', name: 'public runtime console smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_public_runtime_console_v1265.mjs'] },
  { tag: 'syntax', name: 'boot recovery smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_boot_recovery_v1.mjs'] },
  ...
  { tag: 'rarity', name: 'rarity progression audit', cmd: ['node', 'tests/smoke/smoke_rarity_progression_audit_v1280.mjs'], showSignal: true },
  { tag: 'content', name: 'Drowned Reliquary slice', cmd: ['node', 'tests/smoke/smoke_drowned_reliquary_vertical_slice_v1281.mjs'] },
  { tag: 'content', name: 'Drowned Reliquary content slice', cmd: ['node', 'tests/smoke/smoke_drowned_reliquary_content_slice_v1.mjs'] },
  { tag: 'content', name: 'Drowned Reliquary events', cmd: ['node', 'tests/smoke/smoke_drowned_reliquary_events_v1290.mjs'] },
  ...
  { tag: 'public', name: 'public copy v1.27', cmd: ['node', 'tests/smoke/smoke_public_copy_v1260.mjs'], optionalPath: 'tests/smoke/smoke_public_copy_v1260.mjs' },
  { tag: 'public', name: 'public trophy-only revisit v1.27', cmd: ['node', 'tests/smoke/smoke_public_revisit_trophy_only_v1261.mjs'], optionalPath: 'tests/smoke/smoke_public_revisit_trophy_only_v1261.mjs' },
  { tag: 'app', name: 'devtools gate v1.27', cmd: ['node', 'tests/smoke/smoke_devtools_gate_v1262.mjs'], optionalPath: 'tests/smoke/smoke_devtools_gate_v1262.mjs' },
  ...
  { tag: 'spell', name: 'spell mastery v1.32', cmd: ['node', 'tests/smoke/smoke_spell_mastery_v132.mjs'] },
  { tag: 'guildbound', name: 'Guild Oaths v1.33', cmd: ['node', 'tests/smoke/smoke_guild_oaths_v133.mjs'] },
  { tag: 'guildbound', name: 'Lantern Rites v1.33', cmd: ['node', 'tests/smoke/smoke_lantern_rites_v133.mjs'] },
  { tag: 'guildbound', name: 'Crimson Oath QoL v1.33', cmd: ['node', 'tests/smoke/smoke_guildbound_qol_v133.mjs'] },
  ...
  { tag: 'public', name: 'public runtime console gate', cmd: ['node', 'tests/smoke/smoke_public_runtime_console_v1265.mjs'] },
  { tag: 'boot', name: 'boot recovery', cmd: ['node', 'tests/smoke/smoke_boot_recovery_v1.mjs'] },
