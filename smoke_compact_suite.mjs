...
const COMMANDS = [
  ...
  { tag: 'syntax', name: 'Guildbound QoL smoke syntax', cmd: ['node', '--check', 'tests/smoke/smoke_guildbound_qol_v133.mjs'] },
  ...
  { tag: 'guildbound', name: 'Guildbound QoL v1.33', cmd: ['node', 'tests/smoke/smoke_guildbound_qol_v133.mjs'] },
