// DungeonDex v1.7.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.3';
window.DUNGEONDEX_BUILD_QS = '1.7.3-revisit-route-preview';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.3-revisit-route-preview';
