// DungeonDex v1.7.7 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.7';
window.DUNGEONDEX_BUILD_QS = '1.7.7-revisit-criteria-stub-copy-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.7-revisit-criteria-stub-copy-polish';
