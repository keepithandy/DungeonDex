// DungeonDex v1.6.9 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.9';
window.DUNGEONDEX_BUILD_QS = '1.6.9-debt-collector-activation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.9-debt-collector-activation';
