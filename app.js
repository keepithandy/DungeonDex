// DungeonDex v1.6.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.2';
window.DUNGEONDEX_BUILD_QS = '1.6.2-trophy-hall-metadata-density';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.2-trophy-hall-metadata-density';
