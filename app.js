// DungeonDex v1.20.37 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.37';
window.DUNGEONDEX_BUILD_QS = '1.20.37-build-query-label-uniformity-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.37-build-query-label-uniformity-cleanup';
