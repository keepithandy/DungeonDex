// DungeonDex v1.7.9 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.9';
window.DUNGEONDEX_BUILD_QS = '1.7.9-revisit-unlock-gate-model';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.9-revisit-unlock-gate-model';
