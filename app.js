// DungeonDex v1.6.8 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.6';
window.DUNGEONDEX_BUILD_QS = '1.6.6-famous-gear-memory-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.6-famous-gear-memory-foundation';
