// DungeonDex v1.4.29 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.29';
window.DUNGEONDEX_BUILD_QS = '1.4.29-intro-modal-mobile-spacing-audit';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.29-intro-modal-mobile-spacing-audit';
