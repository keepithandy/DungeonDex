// DungeonDex v1.5.0a runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.5.0a';
window.DUNGEONDEX_BUILD_QS = '1.5.0a-talent-browser-smoke-hotfix';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.5.0a-talent-browser-smoke-hotfix';
