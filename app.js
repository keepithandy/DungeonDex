// DungeonDex v1.7.6 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.6';
window.DUNGEONDEX_BUILD_QS = '1.7.6-revisit-route-readiness-summary';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.6-revisit-route-readiness-summary';
