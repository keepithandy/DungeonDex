// DungeonDex v1.20.27 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.27';
window.DUNGEONDEX_BUILD_QS = '1.20.27-first-passive-effect-activation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.27-first-passive-effect-activation';
