// DungeonDex v1.7.10 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.10';
window.DUNGEONDEX_BUILD_QS = '1.7.10-revisit-gate-smoke-hardening';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.10-revisit-gate-smoke-hardening';
