// DungeonDex v1.20.41 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.41';
window.DUNGEONDEX_BUILD_QS = '1.20.41-talent-claim-tracking-plan';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.41-talent-claim-tracking-plan';
