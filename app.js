// DungeonDex v1.6.10 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.10';
window.DUNGEONDEX_BUILD_QS = '1.6.10-famous-gear-memory-expansion';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.10-famous-gear-memory-expansion';
