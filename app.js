// DungeonDex v1.20.14 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.14';
window.DUNGEONDEX_BUILD_QS = '1.20.14-trophy-echo-fallback-smoke-lock';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.14-trophy-echo-fallback-smoke-lock';
