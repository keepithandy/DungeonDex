// DungeonDex v1.4.21 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.21';
window.DUNGEONDEX_BUILD_QS = '1.4.21-cache-hygiene-board-regression';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.21-cache-hygiene-board-regression';
