// DungeonDex v1.12.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.12.2';
window.DUNGEONDEX_BUILD_QS = '1.12.2-talent-ruleset-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.12.2-talent-ruleset-foundation';
