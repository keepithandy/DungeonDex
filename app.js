// DungeonDex v1.12.4 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.12.4';
window.DUNGEONDEX_BUILD_QS = '1.12.4-talent-legacy-preview-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.12.4-talent-legacy-preview-cleanup';
