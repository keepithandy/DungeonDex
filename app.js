// DungeonDex v1.6.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.3';
window.DUNGEONDEX_BUILD_QS = '1.6.3-trophy-hall-archive-shell-prep';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.3-trophy-hall-archive-shell-prep';
