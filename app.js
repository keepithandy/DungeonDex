// DungeonDex v1.4.20 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.20';
window.DUNGEONDEX_BUILD_QS = '1.4.20-board-hunt-balance-feedback';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.20-board-hunt-balance-feedback';
