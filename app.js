// DungeonDex v1.6.13 runtime pointer.
...
window.DUNGEONDEX_BUILD_QS = '1.6.13-combat-accent-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.13-combat-accent-cleanup';
