// DungeonDex v1.4.27 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.27';
window.DUNGEONDEX_BUILD_QS = '1.4.27-roadmap-notes-branch-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.27-roadmap-notes-branch-cleanup';
