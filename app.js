// DungeonDex v1.9.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.9.0';
window.DUNGEONDEX_BUILD_QS = '1.9.0-revisit-unlock-gate-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.9.0-revisit-unlock-gate-foundation';
