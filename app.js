// DungeonDex v1.9.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.9.2';
window.DUNGEONDEX_BUILD_QS = '1.9.2-revisit-gate-checkpoint-audit';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.9.2-revisit-gate-checkpoint-audit';
