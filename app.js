// DungeonDex v1.7.1b runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.1b';
window.DUNGEONDEX_BUILD_QS = '1.7.1b-revisit-system-rule-lock';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.1b-revisit-system-rule-lock';
