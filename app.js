// DungeonDex v1.4.22 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.22';
window.DUNGEONDEX_BUILD_QS = '1.4.22-mobile-board-trophy-readability';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.22-mobile-board-trophy-readability';
