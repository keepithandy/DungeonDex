// DungeonDex v1.16.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.16.2';
window.DUNGEONDEX_BUILD_QS = '1.16.2-talent-preview-copy-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.16.2-talent-preview-copy-polish';
