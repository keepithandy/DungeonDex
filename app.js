// DungeonDex v1.12.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.12.3';
window.DUNGEONDEX_BUILD_QS = '1.12.3-talent-ruleset-integration';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.12.3-talent-ruleset-integration';
