// DungeonDex v1.20.12 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.12';
window.DUNGEONDEX_BUILD_QS = '1.20.12-trophy-echo-detail-hardening';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.12-trophy-echo-detail-hardening';
