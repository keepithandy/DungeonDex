// DungeonDex v1.9.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.9.3';
window.DUNGEONDEX_BUILD_QS = '1.9.3-systems-handoff-audit';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.9.3-systems-handoff-audit';
