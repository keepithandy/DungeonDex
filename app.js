// DungeonDex v1.4.28a runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.28a';
window.DUNGEONDEX_BUILD_QS = '1.4.28a-intro-button-smoke-hotfix';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.28a-intro-button-smoke-hotfix';
