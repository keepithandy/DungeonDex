// DungeonDex v1.6.14 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.14';
window.DUNGEONDEX_BUILD_QS = '1.6.14-legacy-accent-holdout-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.14-legacy-accent-holdout-cleanup';
