// DungeonDex v1.23.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.23.3';
window.DUNGEONDEX_BUILD_QS = '1.23.3-journal-v1-ledger';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.23.3-journal-v1-ledger';
