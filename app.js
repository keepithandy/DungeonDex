// DungeonDex v1.20.4 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.4';
window.DUNGEONDEX_BUILD_QS = '1.20.4-revisit-lane-order-clarification';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.4-revisit-lane-order-clarification';
