// DungeonDex v1.18.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.18.0';
window.DUNGEONDEX_BUILD_QS = '1.18.0-archive-trophy-player-facing-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.18.0-archive-trophy-player-facing-cleanup';
