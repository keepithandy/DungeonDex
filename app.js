// DungeonDex v1.4.14 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.14';
window.DUNGEONDEX_BUILD_QS = '1.4.14-combat-page-framing-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.14-combat-page-framing-cleanup';
