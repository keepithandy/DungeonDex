// DungeonDex v1.23.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.23.0';
window.DUNGEONDEX_BUILD_QS = '1.23.0-trophy-echo-playable-prototype';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.23.0-trophy-echo-playable-prototype';
