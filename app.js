// DungeonDex v1.9.1 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.9.1';
window.DUNGEONDEX_BUILD_QS = '1.9.1-revisit-gate-diagnostics-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.9.1-revisit-gate-diagnostics-polish';
