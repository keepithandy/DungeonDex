// DungeonDex v1.13.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.13.0';
window.DUNGEONDEX_BUILD_QS = '1.13.0-revisit-routes-activation-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.13.0-revisit-routes-activation-foundation';
