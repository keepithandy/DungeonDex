// DungeonDex v1.6.5 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.5';
window.DUNGEONDEX_BUILD_QS = '1.6.5-retired-item-manual-archive-action';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.5-retired-item-manual-archive-action';
