// DungeonDex v1.4.23 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.23';
window.DUNGEONDEX_BUILD_QS = '1.4.23-run-flow-board-integration-audit';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.23-run-flow-board-integration-audit';
