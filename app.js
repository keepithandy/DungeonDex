// DungeonDex v1.6.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.0';
window.DUNGEONDEX_BUILD_QS = '1.6.0-boss-trophy-expansion-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.0-boss-trophy-expansion-foundation';
