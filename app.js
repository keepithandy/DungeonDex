// DungeonDex v1.4.12 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.12';
window.DUNGEONDEX_BUILD_QS = '1.4.12-devtools-load-hygiene';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.12-devtools-load-hygiene';
