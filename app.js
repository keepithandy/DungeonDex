// DungeonDex v1.20.13 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.13';
window.DUNGEONDEX_BUILD_QS = '1.20.13-trophy-echo-detail-contract-lock';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.13-trophy-echo-detail-contract-lock';
