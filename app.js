// DungeonDex v1.33.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.33.0';
window.DUNGEONDEX_BUILD_QS = '1.33.0-guildbound';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.33.0-guildbound';
