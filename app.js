// DungeonDex v1.8.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.8.0';
window.DUNGEONDEX_BUILD_QS = '1.8.0-revisit-unlock-preview';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.8.0-revisit-unlock-preview';
