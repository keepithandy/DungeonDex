// DungeonDex v1.33.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.33.2';
window.DUNGEONDEX_BUILD_QS = '1.33.2-crimson-oath';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.33.2-crimson-oath';
