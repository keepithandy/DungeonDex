// DungeonDex v1.20.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.2';
window.DUNGEONDEX_BUILD_QS = '1.20.2-monster-backdrop-canvas-completion';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.2-monster-backdrop-canvas-completion';
