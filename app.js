// DungeonDex v1.4.13 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.13';
window.DUNGEONDEX_BUILD_QS = '1.4.13-elite-board-contract-identity';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.13-elite-board-contract-identity';
