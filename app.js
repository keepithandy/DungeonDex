// DungeonDex v1.19.1 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.19.1';
window.DUNGEONDEX_BUILD_QS = '1.19.1-current-roadmap-next-systems-audit';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.19.1-current-roadmap-next-systems-audit';
