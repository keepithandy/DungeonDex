// DungeonDex v1.6.5a runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.5a';
window.DUNGEONDEX_BUILD_QS = '1.6.5a-retired-item-manual-action-smoke-hotfix';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.5a-retired-item-manual-action-smoke-hotfix';
