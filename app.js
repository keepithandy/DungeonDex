// DungeonDex v1.6.17 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.17';
window.DUNGEONDEX_BUILD_QS = '1.6.17-current-roadmap-refresh';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.17-current-roadmap-refresh';
