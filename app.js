// DungeonDex v1.5.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.5.3';
window.DUNGEONDEX_BUILD_QS = '1.5.3-talent-release-readiness-sweep';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.5.3-talent-release-readiness-sweep';
