// DungeonDex v1.6.4 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.4';
window.DUNGEONDEX_BUILD_QS = '1.6.4-retired-item-archive-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.4-retired-item-archive-foundation';
