// DungeonDex v1.7.1a runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.1a';
window.DUNGEONDEX_BUILD_QS = '1.7.1a-revisit-candidate-hardening';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.1a-revisit-candidate-hardening';
