// DungeonDex v1.4.15 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.15';
window.DUNGEONDEX_BUILD_QS = '1.4.15-combat-affix-removal';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.15-combat-affix-removal';
