// DungeonDex v1.33.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.33.3';
window.DUNGEONDEX_BUILD_QS = '1.33.3-oathkeepers-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.33.3-oathkeepers-polish';
