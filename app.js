// DungeonDex v1.12.5 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.12.5';
window.DUNGEONDEX_BUILD_QS = '1.12.5-talent-foundation-checkpoint';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.12.5-talent-foundation-checkpoint';
