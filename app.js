// DungeonDex v1.5.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.5.2';
window.DUNGEONDEX_BUILD_QS = '1.5.2-talent-milestone-feedback-clarity';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.5.2-talent-milestone-feedback-clarity';
