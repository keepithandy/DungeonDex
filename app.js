// DungeonDex v1.20.26 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.26';
window.DUNGEONDEX_BUILD_QS = '1.20.26-first-passive-effect-contract-test';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.26-first-passive-effect-contract-test';
