// DungeonDex v1.10.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.10.2';
window.DUNGEONDEX_BUILD_QS = '1.10.2-trophy-echo-rule-handoff-audit';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.10.2-trophy-echo-rule-handoff-audit';
