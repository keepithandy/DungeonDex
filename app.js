// DungeonDex v1.12.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.12.0';
window.DUNGEONDEX_BUILD_QS = '1.12.0-talent-ledger-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.12.0-talent-ledger-foundation';
