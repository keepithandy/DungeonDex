// DungeonDex v1.20.21 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.21';
window.DUNGEONDEX_BUILD_QS = '1.20.21-talent-award-ledger-dry-run';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.21-talent-award-ledger-dry-run';
