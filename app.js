// DungeonDex v1.20.11 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.11';
window.DUNGEONDEX_BUILD_QS = '1.20.11-trophy-echo-detail-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.11-trophy-echo-detail-foundation';
