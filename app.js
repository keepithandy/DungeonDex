// DungeonDex v1.6.22 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.22';
window.DUNGEONDEX_BUILD_QS = '1.6.22-famous-gear-memory-readability';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.22-famous-gear-memory-readability';
