// DungeonDex v1.5.0 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.5.0';
window.DUNGEONDEX_BUILD_QS = '1.5.0-talent-system-foundation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.5.0-talent-system-foundation';
