// DungeonDex v1.6.16 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.16';
window.DUNGEONDEX_BUILD_QS = '1.6.16-repository-archive-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.16-repository-archive-cleanup';
