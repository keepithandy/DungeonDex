// DungeonDex v1.6.24 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.24';
window.DUNGEONDEX_BUILD_QS = '1.6.24-elite-board-contract-clarity';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.24-elite-board-contract-clarity';
