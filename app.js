// DungeonDex v1.20.20 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.20';
window.DUNGEONDEX_BUILD_QS = '1.20.20-talent-milestone-tracking-gate-test';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.20-talent-milestone-tracking-gate-test';
