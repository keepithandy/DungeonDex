// DungeonDex v1.8.1 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.8.1';
window.DUNGEONDEX_BUILD_QS = '1.8.1-revisit-preview-copy-hardening';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.8.1-revisit-preview-copy-hardening';
