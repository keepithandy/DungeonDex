// DungeonDex v1.6.20 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.20';
window.DUNGEONDEX_BUILD_QS = '1.6.20-trophy-hall-mobile-readability';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.20-trophy-hall-mobile-readability';
