// DungeonDex v1.20.3 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.3';
window.DUNGEONDEX_BUILD_QS = '1.20.3-revisit-clarity-label-sync';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.3-revisit-clarity-label-sync';
