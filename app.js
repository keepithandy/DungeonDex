// DungeonDex v1.4.17 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.4.17';
window.DUNGEONDEX_BUILD_QS = '1.4.17-elite-board-bonus-writ-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.4.17-elite-board-bonus-writ-polish';
