// DungeonDex v1.14.0 runtime pointer.
...
window.DUNGEONDEX_BUILD_QS = '1.14.0-revisit-route-content-completion';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.14.0-revisit-route-content-completion';
