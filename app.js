...
window.DUNGEONDEX_BUILD_QS = '1.23.8-board-echo-minimal-playable-activation';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.23.8-board-echo-minimal-playable-activation';
