// DungeonDex v1.23.4 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.23.4';
window.DUNGEONDEX_BUILD_QS = '1.23.4-boss-trophy-v1-completion';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.23.4-boss-trophy-v1-completion';
