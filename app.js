// DungeonDex v1.6.19 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.19';
window.DUNGEONDEX_BUILD_QS = '1.6.19-boss-trophy-smoke-fix';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.19-boss-trophy-smoke-fix';
