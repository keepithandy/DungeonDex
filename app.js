// DungeonDex v1.20.35 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.35';
window.DUNGEONDEX_BUILD_QS = '1.20.35-debt-clarity-renderer-copy-model-dry-run';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.35-debt-clarity-renderer-copy-model-dry-run';
