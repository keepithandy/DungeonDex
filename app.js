// DungeonDex v1.20.5 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.5';
window.DUNGEONDEX_BUILD_QS = '1.20.5-revisit-planning-copy-cleanup';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.5-revisit-planning-copy-cleanup';
