// DungeonDex v1.20.8 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.20.8';
window.DUNGEONDEX_BUILD_QS = '1.20.8-owed-money-text-fix';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.20.8-owed-money-text-fix';
