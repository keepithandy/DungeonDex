// DungeonDex v1.6.1 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.6.1';
window.DUNGEONDEX_BUILD_QS = '1.6.1-boss-trophy-dex-identity-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.6.1-boss-trophy-dex-identity-polish';
