// DungeonDex v1.23.7 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.23.7';
window.DUNGEONDEX_BUILD_QS = '1.23.7-rival-trace-result-detail-polish';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.23.7-rival-trace-result-detail-polish';
    ...
    window.setTimeout(function(){ loadModule('./js/systems/39_board_echo_v1.js?build=' + qs, 'DDBoardEchoV1', 'Board Echo v1'); }, 500);
  }
