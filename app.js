// DungeonDex v1.5.0b runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.5.0b';
window.DUNGEONDEX_BUILD_QS = '1.5.0b-talent-save-load-regression-guard';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.5.0b-talent-save-load-regression-guard';
