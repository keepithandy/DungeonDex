// DungeonDex v1.7.2 runtime pointer.
...
window.DUNGEONDEX_BUILD = '1.7.2';
window.DUNGEONDEX_BUILD_QS = '1.7.2-revisit-route-preview';
...
(function(){
  ...
  function loadExtensions(){
    var qs = window.DUNGEONDEX_BUILD_QS || '1.7.2-revisit-route-preview';
