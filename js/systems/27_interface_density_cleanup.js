...
// DungeonDex v1.7.4 - Interface density and app-feel cleanup.
...
(function(){
  ...
  const BUILD_QS = '1.7.4-revisit-route-detail-panel';
  ...
  function injectCss(){
    ...
    style.textContent = `
      ...
      #talentPanel .talent-state-button{min-height:31px!important;width:100%!important}
