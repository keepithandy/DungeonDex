...
// DungeonDex v1.5.3 - DevTools Balance Reports
// Internal-only measurement layer. It injects into the hidden DevTools overlay and does not touch normal UI.
(function(){
  const REPORT_VERSION = 'DungeonDex v1.5.3';
  const REPORT_BUILD = '1.5.3-talent-release-readiness-sweep-devtools-balance-reports';
