...
// DungeonDex v1.6.16 - DevTools Balance Reports
// Internal-only measurement layer. It injects into the hidden DevTools overlay and does not touch normal UI.
(function(){
  const REPORT_VERSION = 'DungeonDex v1.6.16';
  const REPORT_BUILD = '1.6.16-repository-archive-cleanup-devtools-balance-reports';
