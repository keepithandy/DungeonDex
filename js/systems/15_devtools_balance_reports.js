...
// DungeonDex v1.6.10 - DevTools Balance Reports
// Internal-only measurement layer. It injects into the hidden DevTools overlay and does not touch normal UI.
(function(){
  const REPORT_VERSION = 'DungeonDex v1.6.10';
  const REPORT_BUILD = '1.6.10-famous-gear-memory-expansion-devtools-balance-reports';
