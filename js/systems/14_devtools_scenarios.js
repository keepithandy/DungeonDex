...
// DungeonDex v1.4.28 - DevTools Scenario Presets
// Extension layer for the hidden DevTools overlay. Keeps scenario testing out of normal UI.
(function(){
  const SCENARIO_VERSION = 'DungeonDex v1.4.28';
  const SCENARIO_BUILD = '1.4.28-intro-roadmap-panel-itch-analytics-note';
