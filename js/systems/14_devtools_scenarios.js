...
// DungeonDex v1.5.0b - DevTools Scenario Presets
// Extension layer for the hidden DevTools overlay. Keeps scenario testing out of normal UI.
(function(){
  const SCENARIO_VERSION = 'DungeonDex v1.5.0b';
  const SCENARIO_BUILD = '1.5.0b-talent-save-load-regression-guard-devtools';
