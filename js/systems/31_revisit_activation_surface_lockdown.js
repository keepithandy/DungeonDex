...
// DungeonDex v1.26.5 - Public Revisit Activation Surface Lockdown.
...
(function(){
  ...
  const BUILD = '1.26.5-guild-journal-mobile-reliability';
  const VISIBLE_BUILD = '1.26.5';
  ...
  function safeNoopResult(routeKey){
    return Object.freeze({
      ...
      reason: 'DungeonDex v1.26.5 public Revisit surface only allows Trophy Echo.'
    });
  }
  ...
  function trophyEchoActivationChecklist(state){
    ...
    return Object.freeze({
      ...
      notes: Object.freeze([
        'Trophy Echo is the only active public Revisit lane in v1.26.5.',
  ...
  function routeSurfaceReport(state){
    ...
    return Object.freeze({
      ...
      previewSummary: null,
      notes: Object.freeze([
        'Public v1.26.5 permits Trophy Echo only.',
