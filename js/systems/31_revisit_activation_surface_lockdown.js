...
// DungeonDex v1.28.2 - Public Revisit Activation Surface Lockdown.
...
(function(){
  ...
  const BUILD = '1.28.2-loadout-polish';
  const VISIBLE_BUILD = '1.28.2';
  ...
  function safeNoopResult(routeKey){
    return Object.freeze({
      ...
      reason: 'DungeonDex v1.28.2 public Revisit surface only allows Trophy Echo.'
    });
  }
  ...
  function trophyEchoActivationChecklist(state){
    ...
    return Object.freeze({
      ...
      notes: Object.freeze([
        'Trophy Echo is the only active public Revisit lane in v1.28.2.',
  ...
  function routeSurfaceReport(state){
    ...
    return Object.freeze({
      ...
      previewSummary: null,
      notes: Object.freeze([
        'Public v1.28.2 permits Trophy Echo only.',
