...
// DungeonDex v1.26.6 - Public Revisit Activation Surface Lockdown.
...
(function(){
  ...
  const BUILD = '1.26.6-ashen-anvil-reinforcements';
  ...
  function safeNoopResult(routeKey){
    return Object.freeze({
      ...
      reason: 'DungeonDex v1.26.6 public Revisit surface only allows Trophy Echo.'
    });
  }
  ...
  function trophyEchoActivationChecklist(state){
    ...
    return Object.freeze({
      ...
      notes: Object.freeze([
        'Trophy Echo is the only active public Revisit lane in v1.26.6.',
  ...
  function routeSurfaceReport(state){
    ...
    return Object.freeze({
      ...
      previewSummary: null,
      notes: Object.freeze([
        'Public v1.26.6 permits Trophy Echo only.',
