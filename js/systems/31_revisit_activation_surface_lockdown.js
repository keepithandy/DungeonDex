...
// DungeonDex v1.33.3 - Public Revisit Activation Surface Lockdown.
...
(function(){
  ...
  const BUILD = '1.33.3-oathkeepers-polish';
  ...
  function safeNoopResult(routeKey){
    return Object.freeze({
      ...
      reason: 'DungeonDex v1.33.3 public Revisit surface only allows Trophy Echo.'
    });
  }
  ...
  function trophyEchoActivationChecklist(state){
    ...
    return Object.freeze({
      ...
      notes: Object.freeze([
        'Trophy Echo is the only active public Revisit lane in v1.33.3.',
  ...
  function routeSurfaceReport(state){
    ...
    return Object.freeze({
      ...
      previewSummary: null,
      notes: Object.freeze([
        'Public v1.33.3 permits Trophy Echo only.',
