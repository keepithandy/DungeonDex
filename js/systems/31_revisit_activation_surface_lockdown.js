...
// DungeonDex v1.26.1 - Public Revisit Activation Surface Lockdown.
...
(function(){
  ...
  const BUILD = '1.26.1-public-readiness';
  ...
  function trophyEchoActivationChecklist(state){
    ...
    return Object.freeze({
      ...
      notes: Object.freeze([
        'Trophy Echo is the only active public Revisit lane in v1.26.1.',
  ...
  function routeSurfaceReport(state){
    ...
    return Object.freeze({
      ...
      previewSummary: null,
      notes: Object.freeze([
        'Public v1.26.1 permits Trophy Echo only.',
