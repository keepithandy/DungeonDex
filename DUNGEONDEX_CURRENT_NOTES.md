...
## Current Baseline
- DungeonDex v1.11.0 - Talent Tree Locked Preview UI

## v1.11.0 Talent Tree Locked Preview UI
- Current baseline: v1.11.0.
...
- Talent Tree Locked Preview UI is the next visible lane, but this patch did not change talent gameplay.
