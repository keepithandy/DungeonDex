...
* Renamed the previous expansion identity to Crimson Oath across the current release surfaces.
...
* Removed the DLC wording from the main title so the header stays focused on DungeonDex branding.
