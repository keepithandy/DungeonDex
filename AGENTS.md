...
- Current source release: `v1.33.0 Guildbound` (local release candidate).
...
- No v1.33.0 package is authorized by this version pass; itch.io upload, release tag, and push require explicit authorization.
