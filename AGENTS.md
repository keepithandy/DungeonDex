...
- Current source release: `v1.32.0 Spell Mastery` (local release candidate).
...
- No v1.32.0 package is authorized by this version pass; itch.io upload, release tag, and push require explicit authorization.
