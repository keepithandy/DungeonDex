...
- Current source release: `v1.30.0 Spellbook & Gear Quality of Life` (local release candidate).
...
- The v1.30.0 package is authorized for local review only; itch.io upload, release tag, and push require explicit authorization.
