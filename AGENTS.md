...
- Current source release: `v1.32.2 Merchant Upgrade Hotfix` (local release candidate).
...
- No v1.32.2 package is authorized by this version pass; itch.io upload, release tag, and push require explicit authorization.
