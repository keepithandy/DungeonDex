...
Current baseline: **DungeonDex v1.33.0**

Development continuation: local `main` carries the v1.33.0 Guildbound milestone: Warden Oaths, Guild Renown, and Lantern Rites add meaningful variation to every descent while preserving the established combat and reward foundations. See the [v1.33.0 release record](CHANGELOG.md). No v1.33.0 package has been built, and publishing, upload, tagging, and push remain unauthorized.
...
- **Trophy Echo:** The only active Revisit lane for v1.33.0, tied to boss trophy or boss record history.
...
These systems may exist in old history or compatibility files, but they are not part of the active Revisit surface in v1.33.0:
...
Trophy Echo is the only active Revisit lane for v1.33.0. It stays small and deterministic: if the player has boss trophy history, town surfaces a short memory-reflection loop tied to that boss record.
