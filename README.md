...
Current baseline: **DungeonDex v1.12.4**
...
v1.12.4 is a locked talent preview cleanup step; it does not start active unlock rules, active talent bonuses, or playable revisit routes.
