...
Current baseline: **DungeonDex v1.18.0**
...
v1.18.0 keeps archive and trophy display cleanup separate from gameplay while preserving the locked Talent Tree Preview and the existing smoke coverage.
