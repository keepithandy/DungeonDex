...
async function main() {
  ...
  try {
    ...
    record('First revisit lane contract exists and is stable', !!mutationCheck.firstLane && mutationCheck.firstLane.laneKey === 'trophy-echo' && JSON.stringify(mutationCheck.firstLane) === JSON.stringify(mutationCheck.firstLaneAgain), JSON.stringify(mutationCheck.firstLane));
    record('Second revisit lane contract exists and is stable', !!mutationCheck.secondLane && mutationCheck.secondLane.laneKey === 'famous-gear-memory' && JSON.stringify(mutationCheck.secondLane) === JSON.stringify(mutationCheck.secondLaneAgain), JSON.stringify(mutationCheck.secondLane));
