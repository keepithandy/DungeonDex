...
async function main() {
  ...
  try {
    ...
    const mutationCheck = await evalByValue(client, `(() => {
      ...
      return { snapshot, after, hooks, summary, routes, routeSummary, gates, gateSummary, previews, previewSummary, activationPlan, activationPlanAgain, candidateObjectsBefore, candidateObjectsAfter, routeObjectsBefore, routeObjectsAfter, previewObjectsBefore, previewObjectsAfter, apiKeys, buttons, routeSlotButtons, routeCards, routeSlotText, routeLedgerSnapshot, routePreviewFields };
    })()`);
