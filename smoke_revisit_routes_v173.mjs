...
async function main() {
  ...
  try {
    ...
    record('Trophy Echo detail contract is stable and read-only', fresh.trophyDetail && fresh.trophyDetail.key === 'trophy_echo_route' && fresh.trophyDetail.title === 'Trophy Echo Route' && fresh.trophyDetail.source === 'boss trophies / trophy records' && fresh.trophyDetail.status === 'Planning only' && fresh.trophyDetail.planningOnly === true && fresh.trophyDetail.locked === true && fresh.trophyDetail.readOnly === true && /future side-route concept tied to remembered boss trophies/i.test(fresh.trophyDetail.detail || '') && /first planned revisit route/i.test(fresh.trophyDetail.reason || '') && /route access is unavailable/i.test(fresh.trophyDetail.safety || '') && typeof fresh.trophyDetail.signalCurrent === 'number' && typeof fresh.trophyDetail.signalRequired === 'number' && typeof fresh.trophyDetail.signalPercent === 'number', JSON.stringify(fresh.trophyDetail));
