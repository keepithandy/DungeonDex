...
async function main(){
  ...
  try {
    ...
    record('Baseline town card keeps live Revisit lanes locked without source history', baselineAudit.routeButtons.includes('Echo Locked') && baselineAudit.routeButtons.includes('Memory Locked') && baselineAudit.routeButtons.includes('Trace Locked') && baselineAudit.routeControls === 0 && baselineAudit.trophyStatus?.locked === true && baselineAudit.famousGearStatus?.locked === true && baselineAudit.rivalTraceStatus?.locked === true && baselineAudit.trophyRoute?.playable !== true && baselineAudit.famousGearRoute?.playable !== true && baselineAudit.rivalTraceRoute?.playable !== true && baselineAudit.trophyRoute?.entryAvailable !== true && baselineAudit.famousGearRoute?.entryAvailable !== true && baselineAudit.rivalTraceRoute?.entryAvailable !== true, JSON.stringify({ routeButtons:baselineAudit.routeButtons, routeControls:baselineAudit.routeControls, trophyStatus:baselineAudit.trophyStatus, famousGearStatus:baselineAudit.famousGearStatus, rivalTraceStatus:baselineAudit.rivalTraceStatus, text:baselineAudit.text.slice(0, 500) }));
    ...
    record('Town Revisit surface keeps unfinished lanes inert and separate from live actions', Array.isArray(baselineAudit.unfinishedTownRows) && baselineAudit.unfinishedTownRows.length === 2 && baselineAudit.unfinishedControls === 0 && /Board Echo/i.test(baselineAudit.unfinishedGridText) && /Debt Pressure/i.test(baselineAudit.unfinishedGridText) && /not playable yet/i.test(baselineAudit.unfinishedGridText) && !/Trophy Echo/i.test(baselineAudit.unfinishedGridText) && !/Famous Gear Memory/i.test(baselineAudit.unfinishedGridText) && !/Rival Trace/i.test(baselineAudit.unfinishedGridText) && !/Start Board Echo/i.test(`${baselineAudit.text} ${baselineAudit.unfinishedGridText}`) && !/Start Debt Pressure/i.test(`${baselineAudit.text} ${baselineAudit.unfinishedGridText}`), JSON.stringify({ rows:baselineAudit.unfinishedTownRows, controls:baselineAudit.unfinishedControls, grid:baselineAudit.unfinishedGridText, text:baselineAudit.text.slice(0, 700) }));
    ...
    record('Town card exposes Start Trophy Echo and keeps Famous Gear and Rival Trace locked', availableAudit.routeButtons.includes('Start Trophy Echo') && availableAudit.routeButtons.includes('Memory Locked') && availableAudit.routeButtons.includes('Trace Locked') && availableAudit.routeControls >= 1 && availableAudit.famousGearStatus?.locked === true && availableAudit.rivalTraceStatus?.locked === true && availableAudit.famousGearStatus?.available !== true && availableAudit.rivalTraceStatus?.available !== true && availableAudit.famousGearRoute?.playable !== true && availableAudit.famousGearRoute?.entryAvailable !== true && availableAudit.famousGearRoute?.startAvailable !== true && availableAudit.rivalTraceRoute?.playable !== true && availableAudit.rivalTraceRoute?.entryAvailable !== true && availableAudit.rivalTraceRoute?.startAvailable !== true && unrelatedRoutesInactive, JSON.stringify({ routeButtons:availableAudit.routeButtons, famousGearStatus:availableAudit.famousGearStatus, rivalTraceStatus:availableAudit.rivalTraceStatus, famousGearRoute:availableAudit.famousGearRoute, rivalTraceRoute:availableAudit.rivalTraceRoute, routes:availableAudit.routes }));
    ...
    record('Town Revisit surface keeps unfinished lanes separate after activation checks', Array.isArray(availableAudit.unfinishedTownRows) && availableAudit.unfinishedTownRows.length === 2 && availableAudit.unfinishedControls === 0 && /Board Echo/i.test(availableAudit.unfinishedGridText) && /Debt Pressure/i.test(availableAudit.unfinishedGridText) && /not playable yet/i.test(availableAudit.unfinishedGridText) && !/Trophy Echo/i.test(availableAudit.unfinishedGridText) && !/Famous Gear Memory/i.test(availableAudit.unfinishedGridText) && !/Rival Trace/i.test(availableAudit.unfinishedGridText) && !/Start Board Echo/i.test(`${availableAudit.text} ${availableAudit.unfinishedGridText}`) && !/Start Debt Pressure/i.test(`${availableAudit.text} ${availableAudit.unfinishedGridText}`), JSON.stringify({ rows:availableAudit.unfinishedTownRows, controls:availableAudit.unfinishedControls, grid:availableAudit.unfinishedGridText, text:availableAudit.text.slice(0, 700) }));
