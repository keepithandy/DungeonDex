...
async function main() {
  ...
  const getBossTrophyState = async () => await evalByValue(client, `(() => ({
    ...
    record('Talent award claim tracking plan is read-only and aligned', talentStateContractAudit?.hasClaimTrackingPlan === true && talentStateContractAudit?.hasClaimTrackingPlanSummary === true && talentStateContractAudit?.claimTrackingPlan?.source === 'boss_trophy_milestone' && talentStateContractAudit?.claimTrackingPlan?.status === 'planned' && talentStateContractAudit?.claimTrackingPlan?.claimTrackingReady === false && talentStateContractAudit?.claimTrackingPlan?.currentSaveShapeAddsClaimTracking === false && talentStateContractAudit?.claimTrackingPlan?.currentPatchMutatesSave === false && talentStateContractAudit?.claimTrackingPlan?.plannedClaimPath === 'player.talentLedger.awardClaims' && talentStateContractAudit?.claimTrackingPlan?.plannedClaimKeyPattern === 'boss_trophy_milestone:{bossTrophyId}' && talentStateContractAudit?.claimTrackingPlan?.firstPreviewClaimKey === talentStateContractAudit?.awardPreview?.claimKey && talentStateContractAudit?.claimTrackingPlan?.duplicatePreventionRequired === true && talentStateContractAudit?.claimTrackingPlan?.requiresSaveRepairPatch === true && talentStateContractAudit?.claimTrackingPlan?.requiresLiveAwardPatch === true && talentStateContractAudit?.claimTrackingPlan?.requiresSpendPathPatch === true && talentStateContractAudit?.claimTrackingPlan?.proposedClaimRecordShape?.key === 'boss_trophy_milestone:{bossTrophyId}' && talentStateContractAudit?.claimTrackingPlan?.proposedClaimRecordShape?.source === 'boss_trophy_milestone' && talentStateContractAudit?.claimTrackingPlan?.proposedClaimRecordShape?.sourceId === '{bossTrophyId}' && talentStateContractAudit?.claimTrackingPlan?.proposedClaimRecordShape?.amount === 1 && talentStateContractAudit?.claimTrackingPlan?.proposedClaimRecordShape?.version === 1 && Array.isArray(talentStateContractAudit?.claimTrackingPlan?.rules) && talentStateContractAudit.claimTrackingPlan.rules.length === 5 && talentStateContractAudit?.hadAwardClaimsBefore === false && talentStateContractAudit?.hadAwardClaimsAfter === false && talentStateContractAudit?.beforeLedger === talentStateContractAudit?.afterLedger && talentStateContractAudit?.beforeState === talentStateContractAudit?.afterState, JSON.stringify(talentStateContractAudit?.claimTrackingPlan));
    record('Talent award claim save shape preview is read-only and aligned', talentStateContractAudit?.hasClaimShapePreview === true && talentStateContractAudit?.hasClaimShapePreviewSummary === true && talentStateContractAudit?.claimShapePreview?.path === 'player.talentLedger.awardClaims' && talentStateContractAudit?.claimShapePreview?.status === 'dry_run' && talentStateContractAudit?.claimShapePreview?.saveFieldExists === false && talentStateContractAudit?.claimShapePreview?.wouldAddSaveField === true && talentStateContractAudit?.claimShapePreview?.mutatesSave === false && talentStateContractAudit?.claimShapePreview?.awardsPoints === false && talentStateContractAudit?.claimShapePreview?.grantsCurrency === false && talentStateContractAudit?.claimShapePreview?.enablesSpending === false && talentStateContractAudit?.claimShapePreview?.requiresRepairPatch === true && talentStateContractAudit?.claimShapePreview?.requiresLiveAwardPatch === true && talentStateContractAudit?.claimShapePreview?.expectedShape === 'object_map' && talentStateContractAudit?.claimShapePreview?.expectedEmptyValue && !Array.isArray(talentStateContractAudit.claimShapePreview.expectedEmptyValue) && Object.keys(talentStateContractAudit.claimShapePreview.expectedEmptyValue).length === 0 && talentStateContractAudit?.claimShapePreview?.allowedRecordVersion === 1 && talentStateContractAudit?.claimShapePreview?.claimKeyPattern === talentStateContractAudit?.claimTrackingPlan?.plannedClaimKeyPattern && talentStateContractAudit?.claimShapePreview?.proposedRecordShape?.source === 'boss_trophy_milestone' && talentStateContractAudit?.claimShapePreview?.proposedRecordShape?.amount === 1 && Array.isArray(talentStateContractAudit?.claimShapePreview?.repairRules) && talentStateContractAudit.claimShapePreview.repairRules.length === 5 && talentStateContractAudit?.beforeLedger === talentStateContractAudit?.afterLedger && talentStateContractAudit?.beforeState === talentStateContractAudit?.afterState, JSON.stringify(talentStateContractAudit?.claimShapePreview));
    record('Talent award claim save shape preview reports malformed records without repair', talentStateContractAudit?.malformedClaimPreview?.saveFieldExists === true && talentStateContractAudit?.malformedClaimPreview?.wouldAddSaveField === false && talentStateContractAudit?.malformedClaimPreview?.observedState?.hasTalentLedger === true && talentStateContractAudit?.malformedClaimPreview?.observedState?.hasAwardClaims === true && talentStateContractAudit?.malformedClaimPreview?.observedState?.awardClaimsType === 'object' && talentStateContractAudit?.malformedClaimPreview?.observedState?.validClaimCount === 1 && talentStateContractAudit?.malformedClaimPreview?.observedState?.malformedClaimCount === 2 && talentStateContractAudit?.malformedClaimBefore === talentStateContractAudit?.malformedClaimAfter, JSON.stringify(talentStateContractAudit?.malformedClaimPreview));
