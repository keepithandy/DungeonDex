...
async function main() {
  ...
  const getBossTrophyState = async () => await evalByValue(client, `(() => ({
    ...
    record('v1.23.0 build label is visible after reload', v12049Api?.build === '1.23.0' && String(v12049Api?.visibleLabel || '').includes('v1.23.0'), JSON.stringify({ build: v12049Api?.build, visibleLabel: v12049Api?.visibleLabel }));
